...
Finally, while the library was expanded to 3,116 compounds, this remains small relative to typical virtual screening campaigns (10$^{4}$--10$^{6}$ compounds). Expanding further via additional BRICS refinement (using the \texttt{--refine} flag) or incorporating larger external libraries would likely identify additional candidates.
