...
\begin{itemize}
    ...
    \item OpenMM gas-phase minimisation confirmed local minima for all top candidates; short MD revealed significant ligand drift (RMSD 5.2--7.7 \AA) for all candidates, and explicit-solvent MD (100~ps NPT) showed complete dissociation for the three candidates validated (RMSD 9.0--9.8 \AA), requiring these compounds to be treated as scaffold hypotheses pending longer MD and/or induced-fit docking
\end{itemize}
