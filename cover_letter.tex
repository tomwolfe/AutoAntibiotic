...
\begin{itemize}
    ...
    \item OpenMM gas-phase minimisation confirmed local minima for all top candidates; short MD revealed significant ligand drift (RMSD 5--8 \AA), highlighting the need for further refinement
\end{itemize}
